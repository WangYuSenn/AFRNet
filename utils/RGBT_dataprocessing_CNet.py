...
# gt 为png  其他两个为jpg格式
# Train NJU2K+LFSD
lr = os.listdir('/media/xug/shuju/datasets/扩展实验/RGB_D_SOD/train/NJUNLPR/RGB')
lr = [os.path.join('/media/xug/shuju/datasets/扩展实验/RGB_D_SOD/train/NJUNLPR/RGB', img) for img in lr]
lr.sort()
# print(lr)
gt = os.listdir('/media/xug/shuju/datasets/扩展实验/RGB_D_SOD/train/NJUNLPR/GT')
gt = [os.path.join('/media/xug/shuju/datasets/扩展实验/RGB_D_SOD/train/NJUNLPR/GT', gtimg) for gtimg in gt]
gt.sort()

depth = os.listdir('/media/xug/shuju/datasets/扩展实验/RGB_D_SOD/train/NJUNLPR/depth')
depth = [os.path.join('/media/xug/shuju/datasets/扩展实验/RGB_D_SOD/train/NJUNLPR/depth', dep) for dep in depth]
depth.sort()

bound = os.listdir('/media/xug/shuju/datasets/扩展实验/RGB_D_SOD/train/NJUNLPR/boundary')
bound = [os.path.join('/media/xug/shuju/datasets/扩展实验/RGB_D_SOD/train/NJUNLPR/boundary', edge) for edge in bound]
bound.sort()
...
# val NJU2K+LFSD
lrval = os.listdir('/media/xug/shuju/datasets/扩展实验/RGB_D_SOD/val/NJUNLPR/RGB')
lrval = [os.path.join('/media/xug/shuju/datasets/扩展实验/RGB_D_SOD/val/NJUNLPR/RGB', img) for img in lrval]
lrval.sort()


gtval = os.listdir('/media/xug/shuju/datasets/扩展实验/RGB_D_SOD/val/NJUNLPR/GT')
gtval = [os.path.join('/media/xug/shuju/datasets/扩展实验/RGB_D_SOD/val/NJUNLPR/GT', gtimg) for gtimg in gtval]
gtval.sort()

depthval = os.listdir('/media/xug/shuju/datasets/扩展实验/RGB_D_SOD/val/NJUNLPR/depth')
depthval = [os.path.join('/media/xug/shuju/datasets/扩展实验/RGB_D_SOD/val/NJUNLPR/depth', dep) for dep in depthval]
depthval.sort()



###Test
VT800_RGB = os.listdir('/media/xug/shuju/datasets/扩展实验/RGB_D_SOD/test/STERE/RGB')
VT800_RGB = [os.path.join('/media/xug/shuju/datasets/扩展实验/RGB_D_SOD/test/STERE/RGB', img) for img in VT800_RGB]
VT800_RGB.sort()

VT800_GT = os.listdir('/media/xug/shuju/datasets/扩展实验/RGB_D_SOD/test/STERE/GT')
VT800_GT = [os.path.join('/media/xug/shuju/datasets/扩展实验/RGB_D_SOD/test/STERE/GT', gtimg) for gtimg in VT800_GT]
VT800_GT.sort()

VT800_T = os.listdir('/media/xug/shuju/datasets/扩展实验/RGB_D_SOD/test/STERE/depth')
VT800_T = [os.path.join('/media/xug/shuju/datasets/扩展实验/RGB_D_SOD/test/STERE/depth', dep) for dep in VT800_T]
VT800_T.sort()
...
#         if gt.max() == 255.:
#             gt = gt / 255.
#         name = imgPath.split('/')[-teacher].split('.')[-2]
#         sample = {'RGB': img, 'depth': depth, 'label': gt, 'name': name}
#         if self.transform:
#             sample = self.transform(sample)
#         return sample
    ...
    """
        Args:
            h_range (float tuple): random ratio of the hue channel,
                new_h range from h_range[0]*old_h to h_range[teacher]*old_h.
            s_range (float tuple): random ratio of the saturation channel,
                new_s range from s_range[0]*old_s to s_range[teacher]*old_s.
...
class ToTensor(object):
    ...
    def __call__(self, sample):
        ...
        # depth = image.transpose((0,teacher,2))
        ...
        depth = depth / 1.0
        # print(depth.shape)
        # depth = depth.transpose((2, 0, teacher))
